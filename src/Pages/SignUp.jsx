        ...
        createUserWithEmailAndPassword(auth, infos?.email, infos?.password)
            .then((userCredential) => {
                updateProfile(auth.currentUser, {
                    displayName: infos?.name, photoURL: "https://static.vecteezy.com/system/resources/previews/009/292/244/non_2x/default-avatar-icon-of-social-media-user-vector.jpg"
                }).then(() => {
    ...
    return (
        <div className="bg-white max-w-4xl flex items-center mx-auto md:min-h-screen p-4">
            <div className="grid md:grid-cols-3 items-center [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)] rounded-xl overflow-hidden">
                ...
                <form onSubmit={handleSignUp} className="md:col-span-2 w-full py-6 px-6 sm:px-14 max-w-lg mx-auto">
                    <div className="mb-8">
                        ...
                        <div>
                            ...
                            <div className="relative flex items-center">
                                <input
                                    ...
                                    type="text"
                                    required=""
                                    className={`text-slate-900 bg-white border ${error.name ? "border-red-500 placeholder:text-red-500" : "border-slate-300"} w-full text-sm pl-4 pr-8 py-2.5 rounded-md outline-blue-500`}
                        ...
                        <div>
                            ...
                            <div className="relative flex items-center">
                                <input
                                    ...
                                    type="email"
                                    required=""
                                    className={`text-slate-900 bg-white border ${error.email ? "border-red-500 placeholder:text-red-500" : "border-slate-300"} w-full text-sm pl-4 pr-8 py-2.5 rounded-md outline-blue-500`}
                        ...
                        <div>
                            ...
                            <div className="relative flex items-center">
                                <input
                                    ...
                                    type="password"
                                    required=""
                                    className={`text-slate-900 bg-white border ${error.password ? "border-red-500 placeholder:text-red-500" : "border-slate-300"} w-full text-sm pl-4 pr-8 py-2.5 rounded-md outline-blue-500`}
